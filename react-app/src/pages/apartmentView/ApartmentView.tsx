      ...
      <>
        ...
        {realEstate?.imagePath ? (
          <>
            <CardMedia
              ...
              height="300"
              alt="Apartment"
              src={process.env.UPLOADS_URL + realEstate.imagePath}
              title="Apartment"
            />
          </>
        ) : (
        ...
        <Grid container item xs={12} spacing={1} className={classes.container}>
          <Grid item xs={12}>
            ...
            >
              Månedsleie:{" "}
              <span className={classes.secondInformationTextMobile}>
                {realEstate?.price}
              </span>{" "}
            </Typography>
            <Typography
          ...
          <Grid item xs={12}>
            <Card className={classes.cardContentMobile}>
              <CardContent>
                ...
                <br />
                <Button className={classes.buttonRediger}>
                  Rediger annonse
                </Button>
                <br />
